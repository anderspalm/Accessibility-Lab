...
public class MainActivity extends AppCompatActivity implements ProjectXMapFragment.OnDataPass, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void setUpActionBar() {
        ...
        tabLayout.addTab(tabLayout.newTab().setContentDescription("A link to a map of harassment").setIcon(R.drawable.map));
        tabLayout.addTab(tabLayout.newTab().setContentDescription("A link to graphs").setIcon(R.drawable.stats));
        tabLayout.addTab(tabLayout.newTab().setContentDescription("A link to a profile page").setIcon(R.drawable.profile));
